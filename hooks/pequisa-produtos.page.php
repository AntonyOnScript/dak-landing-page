...
add_action('admin_menu', 'reservas_anexarAoMenu');
function reservas_anexarAoMenu() {
    global $slugPagina;
    add_menu_page('Reservas', 'Reservas', 'manage_options', $slugPagina, 'reservas_gerarVisao', null, 3);
}

function reservas_gerarVisao() { ?>
    <!DOCTYPE html>
    <html>
    <head>
        <!-- ======= VUE begin ======= -->
